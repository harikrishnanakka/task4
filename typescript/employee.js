...
(_a = document.querySelector(".handle-pic")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", hidehandle);
...
function employeeTableInit() {
    ...
    function createCheckboxes(selector, dataSet) {
        ...
        if (!container)
            return;
        container.innerHTML = "";
        Array.from(dataSet).forEach((value) => {
    ...
    letters.forEach((letter) => {
        letter.addEventListener("click", function () {
            ...
            rows.forEach(row => {
                ...
                const status = (_b = (_a = row.querySelector("td:nth-child(7) .status")) === null || _a === void 0 ? void 0 : _a.textContent) === null || _b === void 0 ? void 0 : _b.trim();
                const location = (_d = (_c = row.querySelector("td:nth-child(3)")) === null || _c === void 0 ? void 0 : _c.textContent) === null || _d === void 0 ? void 0 : _d.trim();
                const department = (_f = (_e = row.querySelector("td:nth-child(4)")) === null || _e === void 0 ? void 0 : _e.textContent) === null || _f === void 0 ? void 0 : _f.trim();
                const selectedStatus = Array.from(document.querySelectorAll(".status-filter input:checked")).map(cb => cb.value);
                const selectedLocation = Array.from(document.querySelectorAll(".location-filter input:checked")).map(cb => cb.value);
                const selectedDepartment = Array.from(document.querySelectorAll(".department-filter input:checked")).map(cb => cb.value);
                const alphabetMatch = firstLetter === selectedLetter;
                ...
                const departmentMatch = selectedDepartment.length === 0 ||
...
function toggleDeleteButton() {
    ...
    const visibleCheckboxes = visibleRows
        ...
        .filter((cb) => cb !== null);
    const isAllChecked = visibleCheckboxes.length > 0 &&
    ...
    document.addEventListener("click", (e) => {
        ...
        menu.addEventListener("click", (event) => {
            ...
            if (!(event.target instanceof HTMLElement))
                return;
            const empId = (_b = (_a = row.cells[5]) === null || _a === void 0 ? void 0 : _a.textContent) === null || _b === void 0 ? void 0 : _b.trim();
            if (!empId)
                return;
...
function setupFilters() {
    ...
    applyBtn.addEventListener('click', function () {
        ...
        multiSelects.forEach(function (multiSelect) {
            var _a;
            const key = (_a = [...multiSelect.classList]
                .find(c => c.endsWith('-filter'))) === null || _a === void 0 ? void 0 : _a.replace('-filter', '');
            if (key) {
...
function applyTableFilters(filters) {
    ...
    rows.forEach(function (row) {
        var _a, _b, _c, _d;
        const name = (_a = row.querySelector('.user-cell strong')) === null || _a === void 0 ? void 0 : _a.textContent.trim();
        const firstLetter = name ? name.charAt(0).toUpperCase() : "";
        const location = (_b = row.querySelector('td:nth-child(3)')) === null || _b === void 0 ? void 0 : _b.textContent.trim();
        const department = (_c = row.querySelector('td:nth-child(4)')) === null || _c === void 0 ? void 0 : _c.textContent.trim();
        const status = (_d = row.querySelector('td:nth-child(7) .status')) === null || _d === void 0 ? void 0 : _d.textContent.trim();
...
function setupTableHeaderSorting() {
    ...
    function getCellText(row, colIndex) {
        ...
        if (strong)
            return ((_a = strong.textContent) === null || _a === void 0 ? void 0 : _a.trim()) || '';
        const span = cell.querySelector('.status');
        if (span)
            return ((_b = span.textContent) === null || _b === void 0 ? void 0 : _b.trim()) || '';
        return ((_c = cell.textContent) === null || _c === void 0 ? void 0 : _c.trim()) || '';
    }
}
